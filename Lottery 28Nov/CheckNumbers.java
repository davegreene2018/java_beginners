...
public class CheckNumbers {
	...
	int[][] history = new int [10][6];
	int gameNumber = 1;
	int lineCounter =1;
	int historyCounter =0;


	public void setHistoryCounter(int value){
		this.historyCounter = value;
	}
	...
	// set history
		public void setMyHistory(int[][] value) {
			this.history = value;
	}
	...
	public void checkNumbers (){
			...
			System.out.println("Game "+gameNumber + " line "+line + " you have " +lineCounter + " matches, total Winnings = " + winningsLine);
		...
		public void displayNumbers (){
		  ...
		  public void displayWinningNumbers(){
		   ...
		   public void displayHistory(){
			...
			System.out.println(Arrays.deepToString(history).replace("[[","[").replace("],","]").replace("]]","]"));  // display winning numbers
		 	System.out.println("***************************************************************");
}
}
